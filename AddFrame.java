...
btnSave = new JButton("Save");				btnSave.setFont(f);		btnSave.setAlignmentX(Component.CENTER_ALIGNMENT);
...
Student stu = new Student(rno, sname, m1, m2, m3);
stu.setRno(rno);
stu.setName(sname);
stu.setM1(m1);
stu.setM2(m2);
...
JOptionPane.showMessageDialog(new JDialog(), rno + " added");
txtSrno.setText(""); 
txtSname.setText(""); 
txtSmarks1.setText(""); 
txtSmarks2.setText(""); 
